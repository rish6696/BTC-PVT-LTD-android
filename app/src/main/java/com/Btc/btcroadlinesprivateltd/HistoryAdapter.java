...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryHolder> {
    ...
    public void onBindViewHolder(@NonNull HistoryHolder historyHolder, int i) {
        String name=bookinglist.get(i).partyAdvance.partyname;
        ...
        historyHolder.alphabet.setBackgroundColor(Getcolour());
        historyHolder.dat.setText(bookinglist.get(i).date);
        historyHolder.tim.setText(bookinglist.get(i).time);
        historyHolder.partyname.setText(bookinglist.get(i).partyAdvance.partyname);
